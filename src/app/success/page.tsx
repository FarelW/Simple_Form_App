...
export default function Success() {
    ...
    const formData: FormData | null = location.state?.formData;
        ...
        <div>
            {!clickedbill ? (
                <div className="main-container">
                    ...
                    <div className='succesful-title'>Payment Successful</div>
                    <div className='succesful-label'>Redirecting to Bill details</div>
                    <button className='redirect-button' onClick={()=>setClicked(true)}>Go to Bill</button>
                </div>
            ) : (
                formData ? (
                    <div className="flex items-center justify-center h-screen">
                        <div className="max-w-xl w-[80%] p-6 bg-white shadow-md rounded-md font-montserrat">
                            ...
                            <div className="mt-4 text-center">
                                <Link to="/" className="text-blue-500 hover:text-blue-700 font-semibold underline">
                                    Back to Home
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="min-h-screen font-montserrat sm:p-5 flex items-center justify-center">
                        <div className=" text-3xl sm:text-4xl font-semibold text-gray-600 text-normal mb-10">
